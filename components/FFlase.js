...
import FlasePosition_Method from '../logic/FlasePosition_Method';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import { DataTable } from '../logic/FlasePosition_Method';

export default function FFlase() {
	...
	let calFalsePosition = (event) => {
		event.preventDefault()

		let roots = FlasePosition_Method(L, R, Equation);
	...
	return (
		<div>
			<div className='FlasePosition'>
				<form onSubmit={calFalsePosition} >
					...
					<div class="mb-3 row g-3">
						<div class="col-auto">
							<button type="submit" class="btn border-5 rounded-4 btn-warning">Calculate</button>
						</div>
